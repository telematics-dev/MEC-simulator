...
// Create MEC Hosts
  ...
  h.SetHostIntercellDelay(0.002);
  h.SetCpuMips(300000/10);
  h.SetVirtualMemSize(16*1024);
  h.SetSizeOfStorage(240*1024);
  Ptr<MecHostContainer> hostContainer = h.InstallMecHostsFourCell(bsContainer, sys);
