...
#ifndef MEC_MESSAGE_ONBOARD_APP_PACKAGE_RESPONSE_H
#define MEC_MESSAGE_ONBOARD_APP_PACKAGE_RESPONSE_H
...
class OnboardAppPkgResponse : public Object
{
public:
  static TypeId GetTypeId (void);


  OnboardAppPkgResponse ();
  virtual ~OnboardAppPkgResponse ();

private:
  Ptr<AppPkgInfo> m_appPkgInfo;
  uint16_t m_respCode;
...
public:
  ...
  void SetAppPkgInfo (Ptr<AppPkgInfo> appPkgInfo);
...
#endif /* MEC_MESSAGE_ONBOARD_APP_PACKAGE_RESPONSE_H */
